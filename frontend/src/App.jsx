          ...
          <Route element={<PersistLogin />}>
            ...
            <Route path="/dashboard">
              ...
              <Route element={<ProtectedBillingRoute />}>
                ...
                {/* lazy load for roles other than bursar or admin or superadmin */}
                ...
                {/* lazy load for roles other than teacher or admin or superadmin */}
                ...
                {/* lazy load for roles other than admin or superadmin */}
                ...
                {/* lazy load for roles other than superadmin */}
                ...
                {/* lazy load for roles other than teacher, admin or superadmin */}
