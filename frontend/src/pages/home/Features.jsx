  ...
  return (
    <>
      ...
      <section className="py-24 text-center bg-gradient-to-b from-gray-950 to-gray-900 px-4">
        <h1 className="text-5xl md:text-6xl font-extrabold text-white mb-6 leading-tight">Features</h1>
        ...
        <div className="flex flex-row gap-6 mt-8 md:hidden justify-center">
          ...
          <NavLink to="/features" className="text-gray-300 hover:text-white text-sm">Features</NavLink>
          <NavLink to="/pricing" className="text-gray-300 hover:text-white text-sm">Pricing</NavLink>
          <NavLink to="/contact" className="text-gray-300 hover:text-white text-sm">Contact</NavLink>
        </div>
      </section>
      ...
      <section className="py-24 max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 px-6">
        {features.map((f, idx) => {
          ...
          return (
            ...
            >
              <div className="w-16 h-16 mx-auto mb-6 rounded-full flex items-center justify-center bg-gray-800 shadow-inner">
                <Icon className={`w-10 h-10 ${f.color}`} />
              </div>
