    ...
    <main className="min-h-screen flex items-start justify-center bg-gray-950 p-6">
      <div className="bg-gray-900 p-6 rounded-lg shadow-md w-full max-w-4xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          {/* Basic Info */}
          <section>
            <h2 className="text-gray-200 font-semibold mb-2">Basic Information</h2>
          ...
          {/* Subjects */}
          <section>
            <h2 className="text-gray-200 font-semibold mb-2">Subjects</h2>
          ...
          {/* Class Levels */}
          <section>
            <h2 className="text-gray-200 font-semibold mb-2">Class Levels & Streams</h2>
              ...
              {school.classLevels.map((cls, idx) => (
                <div key={idx} className="bg-gray-800 p-3 rounded">
                  <input
                    ...
                    className="w-full mb-2 p-2 rounded bg-gray-700 text-white text-sm"
                  />
          ...
          {/* Grading System */}
          <section>
            <h2 className="text-gray-200 font-semibold mb-2">Grading System</h2>
                    ...
                    <tr key={idx}>
                      <td>
                        <input
                          ...
                          className="w-16 p-1 rounded bg-gray-800 text-white text-xs"
                        />
                      </td>
                      <td>
                        <input
          ...
          {/* Fee Expectations */}
          <section>
            <h2 className="text-gray-200 font-semibold mb-2">Fee Expectations</h2>
          ...
          {/* Optional Modules */}
          <section>
            <h2 className="text-gray-200 font-semibold mb-2">Optional Modules</h2>
