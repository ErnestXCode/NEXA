...
const AddFeePage = () => {
  ...
  const selectStudent = (student) => {
    setForm({ ...form, studentId: student._id, studentName: `${student.firstName} ${student.lastName}` });
    setFilteredStudents([]);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(res.data.msg);
      setForm({ ...form, amount: "", note: "", studentId: "", studentName: "" });
    } catch (err) {
  ...
  return (
    <div className="max-w-lg mx-auto p-6 bg-gray-950 text-gray-100 shadow-lg rounded-md mt-6">
      <h2 className="text-2xl font-bold mb-6 text-center">Add Payment / Adjustment</h2>
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="relative">
          ...
          {filteredStudents.length > 0 && (
            <ul className="absolute z-10 w-full bg-gray-900 border border-gray-700 mt-1 max-h-40 overflow-auto rounded shadow-lg">
