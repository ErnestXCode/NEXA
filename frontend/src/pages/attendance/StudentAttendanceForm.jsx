    ...
    <main className="p-6 bg-gray-950 text-white min-h-screen">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        {students.map((student) => (
          <div key={student._id} className="flex justify-between items-center bg-gray-900 p-3 rounded">
        ...
        <button type="submit" className="bg-blue-600 hover:bg-blue-700 p-2 rounded font-semibold mt-3">
          Submit Attendance
        </button>
